...
![](https://velog.velcdn.com/images/son-dan-ha/post/38dd8266-856b-4a26-ac94-9b94a575ce48/image.png)

![](https://velog.velcdn.com/images/son-dan-ha/post/54d5f852-67d3-4146-b947-d97202407f0e/image.png)
...
![](https://velog.velcdn.com/images/son-dan-ha/post/d60167ab-7ca1-48c3-958c-387a873bf177/image.png)
![](https://velog.velcdn.com/images/son-dan-ha/post/6195789e-6ee2-47a1-b325-eb5e4959bc8f/image.png)
...
$f$는 $P$에서 극값을 가지므로 $h(t)$는 $t_0$에서 극값을 갖는다. 
...
이제 다시 정리해보면, $g(x,y)=k$와 접하는 $f(x,y)=c$ 에서 최소(최대) $c$를 찾아야 한다. $∇f$와 $∇g$ 가 평행하면 된다.
