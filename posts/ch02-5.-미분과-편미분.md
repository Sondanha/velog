...
우선 다음 **예시**를 통해 **라그랑주 승수의 상황**을 이해해보도록 하자. 예시에는 [해당 영상](https://youtu.be/lmD9p6J_-TA?si=H9GSO2fDNdZol3vD)을 참고했다.


## Level curve(등고선)과 경로
...
목표
이변수함수 f(x,y)가 있을 때, g(x,y)=k 를 만족하는 x, y에 대해서만 라는 제한조건이 있을 때 이 경우 


이제 다시 정리해보면, 라그랑주 승수란 제약식 $g(x,y,z)=k$을 만족하는 점들 중에서 함수 $f(x,y,z)$ 의 최대값과 최소값을 찾는 방법이다. 

![](https://velog.velcdn.com/images/son-dan-ha/post/44a6a945-caa8-4851-924e-d219a656f3fd/image.png)
